  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-100 p-4">
      <section className="w-full max-w-md rounded-3xl border border-slate-950/10 bg-white p-6 text-slate-950 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight">Acceso interno</h1>
        <p className="mb-6 mt-2 text-sm leading-6 text-slate-600">
          Inicia sesión con una identidad TORO autorizada. El contexto de empresa se resuelve en el servidor.
        </p>
