      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-72 shrink-0 border-r border-cyan-400/10 bg-black/45 px-4 py-5 xl:block">
          <div className="mb-7 flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-black tracking-[0.18em] text-white">TORO</div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="space-y-5 p-4 md:p-6">
              ...
              <Panel className="overflow-hidden p-5">
                <div className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
                  <div className="max-w-3xl">
                    ...
                    <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300">TORO reads the business, weighs source authority, prepares decisions, stages work, and stops before any risky external action without approval.</p>
              ...
              <Panel>
                ...
                <div className="space-y-3 p-4">
                  <div className="border border-slate-800 bg-black/25 p-4 text-xs leading-6 text-slate-300">
                    ...
                    <p className="mt-3">
                      TORO reads the governed blueprint projection from Airtable when credentials are available and falls back to mirrored repository records when they are not. Airtable is a transition/control surface, not the product brain.
                    </p>
            ...
            <footer className="border-t border-cyan-400/10 py-6 text-xs text-slate-500">
              TORO internal-proof foundation. Direct writes to Kross, Alegra, WhatsApp, social channels, reservations, prices, availability, invoices, payments and media deletion remain approval-gated or unimplemented unless explicitly verified.
            </footer>
          </div>
        </div>
      </div>
