...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/dreamcatcher-media/hero-santa-teresa.svg",
        width: 1600,
        height: 1100,
        alt: "Dreamcatcher Hotel Santa Teresa editorial hero artwork",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: pageTitle,
    description: pageDescription,
    images: ["/dreamcatcher-media/hero-santa-teresa.svg"],
  },
};
...
export default async function DreamcatcherLanding() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#120f0b] text-[#fff8ed]">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([hotelStructuredData, faqStructuredData]) }} />
