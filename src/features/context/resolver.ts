 ...
 *
 * Until identity.organization_memberships lands, active/non-revoked user_roles
 * are used as membership evidence. The output marks this as legacy_user_roles so
 * callers do not mistake it for the final membership model.
 */
