...
describe("PeopleLeaveWorkspace", () => {
  it("counts real pending workflow states and labels requests safely", () => {
  ...
  it("does not render write UI when self-service data is unavailable", () => {
    render(
  ...
  it("blocks write UI while canonical sources are unavailable", () => {
    render(
      <PeopleLeaveWorkspace
        state={{
          status: "error",
