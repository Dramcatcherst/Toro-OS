...
| 6 | Omnichannel guest inquiry -> useful response | TERE + Comms | WeSpeak runtime activity verified historically; canonical TERE V5 is Active/Critical; V5 QA packet, evidence template and version-neutral acceptance evaluator are merged | PREPARED / BLOCKED POST-V5 QA | No post-V5 WeSpeak evidence was observed in the 2026-09-24 Gmail recheck. Run isolated post-V5 runtime/hash + 5-scenario QA; real guest testing is prohibited; cross-channel continuity remains separately unverified. See docs/runbooks/TORO_TERE_WESPEAK_V5_RUNTIME_ACCEPTANCE_GATE.md |
| 7 | Quote -> follow-up -> reservation handoff | TERE + Revenue | TERE V5 safe-handoff policy, official `/booking-assist` Kross fallback, Kross transport adapter/intake/normalizer/dry-run/acceptance gates and provider-evidence intake are merged | PREPARED / EXTERNAL TRANSPORT BLOCKED | No verified Kross live transport/run exists. 2026-09-24 recheck found no new provider reply or separate credential/docs email; correct follow-up remains DRAFT / NOT SENT. Public Kross handoff reduces user friction but is not TORO live truth. After authorized follow-up and provider evidence, current_reservations_safe and separate live price/availability gates still must pass. |
...
3. live PMS/Kross read authority for guest journey — internally prepared; external provider/follow-up gate remains;
