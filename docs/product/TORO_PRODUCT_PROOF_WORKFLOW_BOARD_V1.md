...
| 4 | Maintenance issue -> assignment -> proof of ready | RICO / Operations | Current maintenance cognitive pilot; facilities maintenance objects; no-delta guard verified; field-proof rebaseline identifies Room 2 toilet as first closure candidate | RUNNING | Current round has 21/21 pending, 0 PASS/FAIL/evidence. Complete one physical verification packet and reach verified_closed without duplicate ticketing. See docs/evidence/TORO_MAINTENANCE_FIELD_PROOF_REBASELINE_2026-09-23.md |
| 5 | Room/area readiness before guest impact | RICO / Operations | Current guest-ready maintenance proof and inspection structures; 21 current target-close checks exist | RUNNING | Physical evidence is the blocker: 21 target-close checks remain pending. Prove explicit ready/not-ready outcome after correction; do not infer readiness from reported resolution. |
