-- TORO Brain maintenance daily round generator — pre-change rollback source
-- Captured: 2026-09-23
-- Project: abtyrbqlqbsastmridzp
-- Function: facilities.create_daily_maintenance_round(date)
-- Pre-change pg_get_functiondef MD5: 080aca2d53cc87f637ac2ddb9a5e75c9
-- To rollback the no-delta guard, apply this exact CREATE OR REPLACE FUNCTION definition
-- through the governed Supabase migration path.
